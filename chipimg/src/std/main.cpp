...
int main(int argc, char** argv)
{
    ...
    for (size_t gi=0; gi<l2_points_with_idx.size(); ++gi) {
        ...
        Grid6x2Result grid = fitGrid6x2(pts_in_group, anchor, kSameColDx);
    ...
    setWindowTitle(w5, cv::format(
        "6x2 fit: Anchor=(r5,c1), same-col |dx|<=30 | Grid(2x8): nodes=%zu | L2=%zu | Anchors=%zu | Row-abnormal tol=%.1f",
